...
class SentenceTransformer(nn.Sequential):
    ...
    def fit(self,
        ...
        :param evaluator: An evaluator (sentence_transformers.evaluation) evaluates the model performance during training on held-out dev.txt data. It is used to determine the best model that is saved to disc.
